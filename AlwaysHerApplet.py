...
with tab1:
    ...
    with col1:
        ...
        st.data_editor(song_summary_col1, hide_index=True, use_container_width=True, height=562)
    ...
    with col4:
        ...
        st.dataframe(growth_rate_per_song, hide_index=True, use_container_width=True, height = 562)
